...
0.3.0. The first consumer is [jev-for-chrome](https://github.com/chy4pro/jev-for-chrome), whose shared code this package grew out of. See [DESIGN.md](DESIGN.md) for the contract and the reasoning behind it.
